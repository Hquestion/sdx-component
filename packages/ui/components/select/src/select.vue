<template>
    ...
    >
        ...
        >
            <template
                slot="prefix"
                v-if="$slots.prefix || selectedLabelSvg"
            >
                <slot name="prefix">
                    <svg
                        class="icon"
                        aria-hidden="true"
                        v-if="selectedLabelSvg"
                    >
                        <use :xlink:href="`#${selectedLabelSvg}`" />
                    </svg>
                </slot>
            </template>
...
import SdxuOption from './option.vue';
...
import { valueEquals, isIE, isEdge } from 'element-ui/lib/utils/util';
import NavigationMixin from './navigation-mixin';
import { isKorean } from 'element-ui/lib/utils/shared';
import { DEFAULT_MODEL_TYPE_ICON } from '@sdx/utils/src/const/model';
              ...
              this.selected.length === 0) {
                ...
                if (this.filterable) {
                    ...
                    if (this.multiple) {
                        ...
                        if (!this.remote) {
                            this.broadcast('SdxuOption', 'queryChange', '');
    ...
    methods: {
        ...
        handleQueryChange(val) {
          ...
          (typeof this.filterMethod === 'function' || typeof this.remoteMethod === 'function')
            ...
            if (this.remote && typeof this.remoteMethod === 'function') {
                ...
                this.broadcast('SdxuOption', 'queryChange', val);
                this.broadcast('ElOptionGroup', 'queryChange');
            }
            if (this.defaultFirstOption && (this.filterable || this.remote) && this.filteredOptionsCount) {
                this.checkDefaultFirstOption();
        ...
        setSelected() {
            if (!this.multiple) {
                ...
                this.selectedLabelSvg = option.svgIcon;
