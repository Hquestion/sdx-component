<template>
    <div
        class="el-autocomplete sdxu-autocomplete"
...
export default {
    ...
    componentName: 'SdxuAutoComplete',
        ...
        getData(queryString) {
            ...
            this.fetchSuggestions(queryString, (suggestions) => {
                ...
                if (Array.isArray(suggestions)) {
                    ...
                    window.console.error('[Element Error][Autocomplete]autocomplete suggestions must be an array');
                }
            });
        },
        handleChange(value) {
