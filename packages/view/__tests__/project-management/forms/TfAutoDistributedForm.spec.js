...
mockScript();
const TfAutoDistributedForm = require('../../../components/project-management/src/forms/TfAutoDistributedForm').default;
let wrapper = null;
describe('TfAutoDistributedForm', () => {
    beforeEach(() => {
        wrapper = mount(TfAutoDistributedForm, {
            sync: false,
            localVue,
            stubs: {
                transition: false,
