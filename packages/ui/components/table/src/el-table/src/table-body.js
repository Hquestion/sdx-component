...
export default {
    ...
    props: {
        ...
        highlight: Boolean,
        dynamic: Boolean,
        dynamicTopHeight: Number,
        dynamicBottomHeight: Number
    },
    ...
    render(h) {
        ...
        return (
            <table
                ...
                <tbody>
                    {
                        this.dynamic && <tr style={{ height: `${this.dynamicTopHeight}px`, opacity: '0.5' }}/>
                    }
                    {
                    ...
                    {
                        this.dynamic && <tr style={{ height: `${this.dynamicBottomHeight}px`, opacity: '0.5' }}/>
                    }
                </tbody>
            </table>
        );
