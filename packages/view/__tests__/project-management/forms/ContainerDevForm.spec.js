...
mockScript();
const ContainerDevForm = require('../../../components/project-management/src/forms/ContainerDevForm').default;
let wrapper = null;
describe('ContainerDevForm', () => {
    beforeEach(() => {
        wrapper = mount(ContainerDevForm, {
            localVue,
            stubs: {
                transition: false,
                'el-form': true,
