export default {
    ...
    view: {
        task: {
            ...
            killTaskTitle: '任务终止提示',
            killTaskContent: '您确定要终止此任务吗？',
            deleteTaskTitle: '任务删除提示',
            deleteTaskContent: '您确定要删除此任务吗？',
            ...
            GPUUsageRate: 'GPU平均使用率（%）',
            GPUMemoryUsage: 'GPU-显存使用量（MB）',
            TailView: 'tail查看',
            HeadView: 'head查看',
            AutoPull: '自动拉取',
            RollingFollow: '滚动跟随',
            ...
            KernalReleaseTime: 'Kernel自动断开连接(分钟)',
            PodReleaseTime: '任务自动释放资源(分钟)',
            ExceedKernalReleaseTime: '超过指定时间, Kernel将自动断开连接',
            ExceedPodReleaseTime: '超过指定时间, 任务将自动停止',
            LimitSessionCount: '最大session连接数',
            EnterIde: '进入SkyIDE',
        ...
        resourceManage: {
            ...
            LessOrEqual: '小于等于',
            NumberUnit: '个',
            TotalConcurrentHighResourceTasks: '全局同时运行的高资源任务总数：',
            MoreOrEqual: '资源设置大于等于',
            CountOfTotalTasksLessOrEqual: '的任务总数小于等于',
            GPUsOccupied: '全局同时占用GPU总数：',
            PieceUnit: '块',
        ...
        dataManagement: {
            ...
            DatasetDescPlaceholder: '请输入数据集描述',
            DatasetLabel: '数据集标签',
            ...
            DetailedDescPlaceholder: 'Markdown格式内容',
            EditDataset: '编辑数据集',
